...
WRITE DB 10, "WRITE A 5 LETTER WORD $"
...
WRONG_ANS DB 10,"WRONG ANSWER, TRY AGAIN $"
...
BUILD_WORD:
    ...
    ;MOV AH, 09H       ; DOS FUNCTION TO SET TEXT COLOR
    ;MOV BL, 0EH       ; YELLOW TEXT ON BLACK BACKGROUND
    ;MOV BH, 0         ; VIDEO PAGE (0 FOR THE DEFAULT)
    ;INT 10H           ; Call interrupt 10h to set text color
    ;MOV AH, 10H ; VIDEO SERVICES
    ;MOV AL, 0CH ; ATTRIBUTE (RED TEXT ON BLACK BACKGROUND)
    ;INT 10H     ; CALL INTERRUPT 10H TO SET THE COLOR
